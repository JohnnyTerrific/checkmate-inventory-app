import{b as g}from"./style-CEtwapeG.js";document.addEventListener("DOMContentLoaded",()=>{h()});function h(){const b=(g()||[]).reverse(),s=document.getElementById("auditTableContainer");let a=1,n=25,i=b;s.innerHTML=`
