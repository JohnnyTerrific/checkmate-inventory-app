import{l as V,d as B,s as N}from"./inventory-Cvhx57H-.js";import"./users-CxsDH44-.js";function O(){return JSON.parse(localStorage.getItem("cm_shipments_v1")||"[]")}function _(e){localStorage.setItem("cm_shipments_v1",JSON.stringify(e))}function E(){return JSON.parse(localStorage.getItem("cm_products_v1")||"[]").map(n=>({...n,name:n.name||n.model||""}))}function F(){const e=JSON.parse(localStorage.getItem("cm_settings_v2")||"{}").vendors||[];return e.length?e:JSON.parse(localStorage.getItem("cm_settings_v1")||"{}").vendors||[]}const j=["FOB","CIF","DAP","EXW","DDP"],R=["Sea","Air","Rail","Truck"],J=["Haifa","Ashdod","Eilat","Ben Gurion","Other"];function H(){const e=document.getElementById("shipmentDialog"),n=E(),I=F();e.innerHTML=`
        <form method="dialog"
