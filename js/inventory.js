...
export async function saveInventory(list) {
  ...
  existing.docs.forEach(docSnap => {
    ...
    // Add/overwrite every unit in `list`
    list.forEach(unit => {
...
export async function loadAuditLog() {
  ...
  // Return array of audit‐log objects (each includes its autogenerated doc ID, if needed)
...
await saveAuditLog(log);
  ...
  document.getElementById("addShipmentBtn").onclick = openCreateShipmentDialog;
